...
public class ProductDetail_Vx0 {
    ...
    public ProductDetailOutput process(ProductDetailInput input) throws Exception {
    ...
    public ProductDetailOutput getData(Connection conn, ProductDetailInput input) throws SQLException {
    ...
    public ProductDetailOutput getHardCodeData(ProductDetailPojo input) throws SQLException {
        ProductDetailOutput pdo = new ProductDetailOutput();
        input.setItemId(11111111L);
        input.setItemTitle("Pride and Prejudice");
        input.setAuthorFName("Jane");
        input.setAuthorLName("Austen");
        pdo.getDetailedProductsList().add(input);
        return (pdo);
    }
}